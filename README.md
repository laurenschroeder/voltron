...
**[Try the game](https://voltron-vert.vercel.app/) and see how much energy you can gather!**

*Built for Mobile and Smart Glasses!*
...
Created by **Nadja Pirchheim** (Logo Design, PM, Video), **Lauren Schroeder** (Programming), **Kaylie Nguyen** (UI / UX Design), **Dilan Ilke Kurt** (Note-taking, Programming), **Suvi Helin** (Programming, 3D Animation, VFX), and **Diya Hu** (3D Modeling, UX Design).

Made as a hackathon entry for [XRCC26](https://www.xrcc.events/xrcc-2026).
